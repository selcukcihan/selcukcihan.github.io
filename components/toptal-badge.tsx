...
export function ToptalBadge() {
  return (
    <div className={styles.root} aria-label="Top 3% talent, vetted by Toptal">
      <div className={styles.shell}>
        <div className={styles.badge}>
          ...
          <h3 className={styles.headline}>TOP 3% TALENT</h3>
          <div className={styles.divider} />
          <span className={styles.vetted}>Vetted by</span>
          <svg
            viewBox="0 0 108 30"
            width="100"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            href="https://www.toptal.com/developers/resume/selcuk-cihan#N4rVw3"
          >
            Hire me
          </a>
        </div>
