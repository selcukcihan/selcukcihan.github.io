...
export const profileData: ProfileData = {
  ...
  bio: [
    ...
    "With 20 years of experience in distributed systems, I have a proven ability to take on technical duties from operations to development and architecture."
  ],
  image: "/profile.png",
  socials: [
    {
