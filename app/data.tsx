export const TESTIMONIALS = [
  {
    ...
    full: <div className="indent-4">
      ...
      <div className="indent-0 pt-4 underline text-center">
        <a href="/references/daniel_vliegenthart.pdf" download="testimonial.pdf">Download original copy</a>
      </div>
    </div>,
